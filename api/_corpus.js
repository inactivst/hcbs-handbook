...
export const CHUNKS = [
  ...
  },
  {
    ...
    text: `The setting must ensure an individual's rights of privacy, dignity and respect, and freedom from coercion and restraint. In practice this covers how staff speak to you, whether your personal information and belongings are respected, and whether you can have private conversations and private personal care. Restraint or seclusion used only for staff convenience, rather than your safety, runs against this right.`,
  },
  {
    id: 'rights-autonomy',
  ...
  },
  {
    ...
    text: `The person-centered planning process must be driven by the individual. It must: include people chosen by the individual; provide necessary information and support to ensure the individual directs the process to the maximum extent possible; be timely and occur at times and locations convenient to the individual; reflect cultural considerations and use plain language; include strategies for solving disagreement; offer choices regarding services and supports and who provides them; and be reviewed and revised upon reassessment at least every 12 months, when circumstances change, or at the individual's request. A provider that delivers your HCBS generally cannot also be your case manager or write your plan, unless the state has an approved safeguard against that conflict of interest. The written plan must reflect the setting chosen by the individual and their strengths, preferences, and goals.`,
  },
  {
    id: 'ca-lanterman-rights',
    title: 'California: Lanterman Act rights',
    citation: 'CA Welfare & Institutions Code § 4502, subds. (b)(1)-(11); § 4502.1',
    text: `In California, people with developmental disabilities have rights under the Lanterman Act (WIC 4500 et seq.), served through 21 regional centers. WIC 4502 guarantees, among others: the right to treatment and habilitation services in the least restrictive environment; dignity, privacy, and humane care; participation in an appropriate publicly supported education program; prompt medical care and treatment; religious freedom and practice; social interaction and participation in community activities; physical exercise and recreation; freedom from harm, including unnecessary physical restraint, isolation, excessive medication, abuse, or neglect; freedom from hazardous procedures; the right to make choices in their own lives, including where and with whom to live, their relationships, how they spend their time (including education, employment, and leisure), and the pursuit of their personal future; and a prompt investigation of any alleged abuse against them. WIC 4502.1 backs this up on the agency side: it requires regional centers and other publicly funded agencies to actually respect the choices a person makes, and to give information in a way that fits the person's language and culture so they can make real choices.`,
  },
  {
    id: 'ca-ipp',
